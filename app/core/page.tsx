...
function generateWorkout(
  ...
  const baseSets =
    experience === "Beginner" ? 3 : experience === "Intermediate" ? 4 : 4;

  const exerciseLimit = duration === 30 ? 3 : duration === 45 ? 4 : 5;

  const templates: Record<
    Goal,
    { title: string; focus: string; exercises: Exercise[] }[]
  > = {
    "Muscle Gain": [
      {
        title: "Push",
        ...
        exercises: [
          { name: "Bench Press", sets: baseSets, reps: "8–10" },
          { name: "Shoulder Press", sets: baseSets, reps: "8–10" },
      ...
      },
      {
        ...
        focus: "Back, Biceps",
        exercises: [
          { name: "Lat Pulldown", sets: baseSets, reps: "8–10" },
          { name: "Seated Row", sets: baseSets, reps: "8–10" },
      ...
      },
      {
        ...
        exercises: [
          { name: "Squat", sets: baseSets, reps: "8–10" },
          { name: "Romanian Deadlift", sets: baseSets, reps: "8–10" },
  ...
  return templates[goal]
    ...
    .map((day, index) => ({
      ...
      title: day.title,
      focus: day.focus,
      exercises: day.exercises.slice(0, exerciseLimit),
    }));
}
...
export default function CorePage() {
  ...
  async function handleSaveWorkout() {
    if (!generated) {
      setSaveMessage("Generate a workout before saving.");
      return;
    }
  ...
  return (
    <main className="min-h-screen bg-white text-zinc-900">
      <header className="sticky top-0 z-50 border-b border-zinc-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          ...
          <nav className="hidden items-center gap-8 text-sm text-zinc-700 md:flex">
            ...
            <Link
              href="/core"
              className="border-b-2 border-purple-600 pb-2 font-semibold text-zinc-900"
            >
              Core
            </Link>

            <Link href="/#product" className="transition hover:text-purple-600">
              Product
            </Link>

            <Link href="/#roadmap" className="transition hover:text-purple-600">
              Roadmap
            </Link>
      ...
      <section className="mx-auto max-w-7xl px-5 py-10 md:py-14">
        <div className="mb-8">
          <p className="text-sm font-bold text-purple-600">/core</p>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-600 md:text-base">
            ...
            workout plan based on your goal, experience level, weekly schedule,
            and available time.
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
          <section className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
            <p className="mb-5 text-sm font-bold text-purple-600">
              1. Your Preferences
            </p>
            ...
            <div className="space-y-5">
              <label className="block">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-zinc-300 bg-white px-3 py-3 text-sm text-zinc-900 outline-none transition focus:border-purple-600"
                >
              ...
              <label className="block">
                ...
                <select
                  value={daysPerWeek}
                  onChange={(event) =>
                    setDaysPerWeek(Number(event.target.value) as DaysPerWeek)
                  }
                  className="w-full rounded-xl border border-zinc-300 bg-white px-3 py-3 text-sm text-zinc-900 outline-none transition focus:border-purple-600"
                >
              ...
              <button
                ...
                className="w-full rounded-xl bg-gradient-to-r from-purple-700 to-purple-500 px-4 py-3 text-sm font-bold text-white shadow-sm transition hover:brightness-110"
              >
                Generate Workout
              </button>
            ...
            {!generated ? (
              <div className="flex min-h-[420px] items-center justify-center text-center">
                <div>
                  ...
                  <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-zinc-500">
                    Select your preferences and click Generate Workout to create
              ...
              <div className="mt-5 space-y-5">
                {workout.map((day) => (
                  ...
                  >
                    <div className="mb-4">
                      ...
                      <p className="mt-1 text-xs text-zinc-500">{day.focus}</p>
                    </div>

                    <div className="overflow-hidden rounded-lg border border-zinc-200 bg-white">
                      <div className="grid grid-cols-[1fr_70px_90px] bg-zinc-100 px-3 py-2 text-xs font-semibold text-zinc-600">
                        <span>Exercise</span>
                      ...
                      {day.exercises.map((exercise) => (
                        <div
                          key={exercise.name}
                          className="grid grid-cols-[1fr_70px_90px] border-t border-zinc-200 px-3 py-3 text-sm"
                        >
                ...
                <button
                  ...
                  disabled={saving}
                  className="w-full rounded-xl bg-purple-600 px-4 py-3 text-sm font-bold text-white transition hover:bg-purple-700 disabled:cursor-not-allowed disabled:opacity-60"
                >
        ...
        <section className="mt-6 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          <div>
            ...
            <p className="mt-1 text-xs text-zinc-500">
              Recent workout plans saved to Supabase.
            </p>
          </div>
                  ...
                  >
                    ...
                    <div className="mt-4 space-y-2 text-sm text-zinc-600">
                      ...
                      <p className="text-xs text-zinc-400">
                        Saved{" "}
                        {new Date(savedWorkout.created_at).toLocaleString(
                          "en-US"
                        )}
                      </p>
                    </div>
